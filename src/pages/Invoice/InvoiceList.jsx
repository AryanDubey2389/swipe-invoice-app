...
const notifyAlert = (msg) => toast.warning(`${msg}`, { position: toast.POSITION.TOP_CENTER });
const InvoiceList = () => {
  ...
  const handleCopyClick = () => {
    ...
    if (!invoice) {
      notifyAlert("Please enter the valid invoice id.");
    } else {
...
const InvoiceRow = ({ invoice, navigate }) => {
  ...
  const handleDeleteClick = (invoiceId) => {
    notify("Invoice deleted successfuly 🥳");
